...
public class Lib : Node {
	...
	public string CandleColorHtmlCode {
		get { return GetFromDb(nameof(CandleColorHtmlCode)); }
		set { SetToDb(nameof(CandleColorHtmlCode), value); }
	}
	...
	public override void _Ready() {
		...
		GD.Randomize();
		InitDbEntry(nameof(BorderColorHtmlCode), "ffad5900");
		InitDbEntry(nameof(BoderEnabled), true);
		InitDbEntry(nameof(BackgroundColorHtmlCode), "ff002054");
		InitDbEntry(nameof(SoundEnabled), true);
		InitDbEntry(nameof(VignetteEnabled), true);
		InitDbEntry(nameof(CandleColorHtmlCode), "ff642121");
